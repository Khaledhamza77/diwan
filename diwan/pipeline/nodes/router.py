...
Use this route ONLY when ALL THREE conditions are simultaneously true:
  ...
  (b) A prior bot turn contains the concrete CITED answer as an explicit statement.
...
If ANY condition is missing — especially (c) — you MUST route to مالي_استرجاع.
...
## Decision rules
1. CITATION GATE: Before choosing مالي_مباشر, scan every prior bot turn for a literal \
   [N] pattern (e.g., [1], [2], [3]). If none exists anywhere in the bot's history, \
   مالي_مباشر is forbidden — use مالي_استرجاع.
