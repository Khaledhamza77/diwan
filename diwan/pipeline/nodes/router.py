...
**مالي_مباشر**
Use this route when EITHER of the following applies:

CASE A — Repeat/summary of prior answers:
The user is asking to repeat, summarize, or recap what was already said in the conversation \
(e.g., "لخص ما قلته", "كرر ما قلته", "اذكر ما ذكرته", "ملخص المحادثة"). \
The history must contain at least one cited bot turn [N] for this case to apply.

CASE B — Direct follow-up on a specific cited answer:
...
If neither case applies — you MUST route to مالي_استرجاع.
...
User: "لخص ما قلته" | History: multiple cited bot turns with [1][2][3] markers
→ { "route": "مالي_مباشر", "reasoning": "المستخدم يطلب ملخصاً للمحادثة السابقة التي تحتوي على إجابات موثقة، لا يلزم بحث جديد.", "confidence": 0.97 }
